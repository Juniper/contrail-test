...
class TestCustomIsolation(BaseK8sTest):
    ...
    def test_service_custom_isolation(self):
        ...
        default_service_network_name = "k8s-default-service-network"
        vn_service_policy = self.setup_contrail_policy(vn1_name = "TestVNNamespace",
                                         vn2_name = default_service_network_name,
