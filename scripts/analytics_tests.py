...
#        self.opsobj=self.ops_inspect.get_ops_generator(generator='nodea29',moduleid='ControlNode')
...
#service instance uve functions
    def get_svc_instance(self,collector,project='admin',instance=None):
        ...
        self.svc_obj= self.ops_inspect[collector].get_ops_svc_instance(svc_instance=instance)
