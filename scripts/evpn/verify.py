...
class VerifyEvpnCases():
    ...
    def verify_ipv6_ping_for_non_ip_communication(self,encap):
        ...
        vn1_vm1_fixture=self.useFixture(VMFixture(project_name= self.inputs.project_name,connections= self.connections, vn_obj= vn1_fixture.obj, image_name= 'ubuntu-traffic', vm_name= vm1_name,node_name= compute_1))
        vn1_vm2_fixture=self.useFixture(VMFixture(project_name= self.inputs.project_name,connections= self.connections, vn_obj= vn1_fixture.obj, image_name= 'ubuntu-traffic', vm_name= vm2_name,node_name= compute_2))
