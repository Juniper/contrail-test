...
class TestIntfMirror6(BaseIntfMirrorTest, VerifyIntfMirror):
    ...
    @preposttest_wrapper
    def test_juniper_header6_ingress(self, direction = 'ingress'):
        ...
        """
        return self.verify_juniper_header_testcase(header=2, direction=direction, ipv6=True)

    @preposttest_wrapper
    def test_juniper_header6_egress(self, direction='egress'):
    ...
    @preposttest_wrapper
    def test_juniper_header6_without_header_ingress(self, direction='ingress'):
        ...
        """
        return self.verify_juniper_header_testcase(header=3, direction=direction, ipv6=True)
