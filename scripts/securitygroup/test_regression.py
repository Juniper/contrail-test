...
class SecurityGroupRegressionTests1(BaseSGTest, VerifySecGroup, ConfigPolicy):
    ...
    '''class SecurityGroupRegressionTestsdummy(BaseSGTest, VerifySecGroup, ConfigPolicy):

    @classmethod
    def setUpClass(cls):
        super(SecurityGroupRegressionTestsdummy, cls).setUpClass()

    @classmethod
    def tearDownClass(cls):
        super(SecurityGroupRegressionTestsdummy, cls).tearDownClass()
