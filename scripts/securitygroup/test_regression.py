...
class SecurityGroupRegressionTests11(BaseSGTest, VerifySecGroup, ConfigPolicy):

    @classmethod
    def setUpClass(cls):
        super(SecurityGroupRegressionTests11, cls).setUpClass()
        cls.option = 'openstack'
...
# end class SecurityGroupRegressionTests11
