...
class TestBasicBMSVMVN(BaseFabricTest):
    ...
    def reconfigure_block_size_tftp(self):
        ...
        self.inputs.restart_container([self.inputs.cfgm_ip],'ironic_pxe')
    ...
    def test_create_ironic_provision_vn(self):
        ...
        self.inputs.restart_container([self.inputs.cfgm_ip],'ironic_conductor')
      
        fabric_name = self.inputs.fabrics[0]['namespaces']['name']
        status,fabric = self._get_fabric_fixture(fabric_name)
    ...
    def test_bms_node_add_delete(self,bms_type=None):
        ...
        self.logger.debug(elf.bms_fixture.ironic_h.obj.node.list())
    ...
    def test_bms_vm_add_delete(self,bms_count=1):
        ...
        for bms_fixture in bms_fixtures_list:
            assert vm_fixture.ping_with_certainty(bms_fixture.vm_ip)
        return True
