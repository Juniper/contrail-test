...
class StandardProfile(object):
    def __init__(self, stream, size=100, count=10, payload=None, capfilter=None,
        ...
        #a particular packet and its never received...timeout avoids dead lock.
...
class ContinuousSportRange(StandardProfile):
    def __init__(self, stream, size=100, startport=8001, endport=8100,
        ...
        super(ContinuousSportRange, self).__init__(stream, size=size, payload=payload,
