    ...
    def verify_fip_from_shared_network_in_demo_project(self):
        ...
        fvn_fixture = self.useFixture(
                VNFixture(
                    ...
                    vn_name=fvn_name, inputs=self.inputs, subnets=fip_subnets, router_asn=self.inputs.router_asn, rt_number=mx_rt, shared=True, router=True))

        vn1_fixture = self.useFixture(
            VNFixture(
                project_name='demo', connections=self.demo_proj_connections1,
                vn_name=vn1_name, inputs=self.demo_proj_inputs1, subnets=vn1_subnets))
        ...
        vm2_fixture = self.useFixture(VMFixture(connections=self.demo_proj_connections1,
        ...
        return True
    #end verify_fip_from_shared_network_in_demo_project
