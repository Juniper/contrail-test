...
import unittest
from tests_with_setup_base_webui import *
...
if __name__ == "__main__":
    ...
    suite.addTest(WebuiTestSanity('test_verify_config_node_advance_details_in_webui_monitor_infra_config_nodes'))
    suite.addTest(WebuiTestSanity('test_verify_vrouter_basic_details_in_webui_monitor_infra_virtual_routers'))
    suite.addTest(WebuiTestSanity('test_verify_vrouter_advance_details_in_webui_monitor_infra_virtual_routers'))
    suite.addTest(WebuiTestSanity('test_verify_analytics_node_basic_details_in_webui_monitor_infra_analytics_nodes'))
    suite.addTest(WebuiTestSanity('test_verify_analytics_node_advance_details_in_webui_monitor_infra_analytics_nodes'))
    suite.addTest(WebuiTestSanity('test_verify_network_basic_details_in_webui_monitor_networking_networks'))
