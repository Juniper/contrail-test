...
if __name__ == "__main__":
    ...
    suite.addTest(WebuiTestSanity('test_control_node_advance_details_in_webui_monitor_infra_control_nodes'))
    suite.addTest(WebuiTestSanity('test_config_node_basic_details_in_webui_monitor_infra_config_nodes'))
    suite.addTest(WebuiTestSanity('test_config_node_advance_details_in_webui_monitor_infra_config_nodes'))
    suite.addTest(WebuiTestSanity('test_vrouter_basic_details_in_webui_monitor_infra_virtual_routers'))
    suite.addTest(WebuiTestSanity('test_vrouter_advance_details_in_webui_monitor_infra_virtual_routers'))
    suite.addTest(WebuiTestSanity('test_analytics_node_basic_details_in_webui_monitor_infra_analytics_nodes'))
    suite.addTest(WebuiTestSanity('test_analytics_node_advance_details_in_webui_monitor_infra_analytics_nodes'))
    suite.addTest(WebuiTestSanity('test_network_basic_details_in_webui_monitor_networking_networks'))
    suite.addTest(WebuiTestSanity('test_network_advance_details_in_webui_monitor_networking_networks'))
    suite.addTest(WebuiTestSanity('test_instance_basic_details_in_webui_monitor_networking_networks'))
    suite.addTest(WebuiTestSanity('test_instance_advance_details_in_webui_monitor_networking_networks'))
