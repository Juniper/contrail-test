...
if __name__ == "__main__":
    ...
    suite.addTest(TestApiPolicyFixture('test_associate_disassociate_api_policy'))
    suite.addTest(TestApiPolicyFixture('test_policy_with_local_keyword_across_multiple_vn'))
    suite.addTest(TestApiPolicyFixture('test_policy_rules_scaling_with_ping_api'))
    ...
    suite.addTest(policyTrafficTestFixture('test_controlnode_switchover_policy_between_vns_traffic'))
    suite.addTest(policyTrafficTestFixture('test_multi_vn_repeated_policy_update_with_ping'))
    suite.addTest(policyTrafficTestFixture('test_policy_multi_vn_modify_rules_of_live_flows'))
    suite.addTest(policyTrafficTestFixture('test_policy_multi_vn_with_multi_proto_traffic'))
    suite.addTest(policyTrafficTestFixture('test_policy_single_vn_modify_rules_of_live_flows'))
    suite.addTest(policyTrafficTestFixture('test_policy_single_vn_with_multi_proto_traffic'))
    suite.addTest(policyTrafficTestFixture('test_scale_policy_with_ping'))
    suite.addTest(policyTrafficTestFixture('test_single_vn_repeated_policy_update_with_ping'))
    suite.addTest(policyTrafficTestFixture('test_policy_rules_scaling'))
    suite.addTest(policyTrafficTestFixture('test_policy_rules_scaling_with_ping'))
    suite.addTest(policyTrafficTestFixture('test_policy_with_scaled_udp_flows'))
