...
class TestRP(RPBase, BaseHC, VerifySvcFirewall):
    ...
    def test_rp_interface_static_ext_community(self):
        ...
        rp = self.configure_term_routing_policy(config_dicts)
        assert self.verify_policy_in_control(ret_dict['vn_fixture'], ret_dict['test_vm'], search_value = 'target:64512:33333'), 'Search term not found in introspect'
