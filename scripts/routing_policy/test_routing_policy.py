...
class TestRP(RPBase, BaseBGPaaS, BaseHC, VerifySvcFirewall):
    ...
    def test_rp_service_interface(self):
        ...
        self.configure_term_routing_policy(vn_fixture = left_vn_fixture, from_term = 'protocol', sub_from = 'service-interface', to_term = 'community', sub_to = '64512:55555')
    ...
    def test_rp_bgpaas(self):
        ...
        self.configure_term_routing_policy(vn_fixture = vn_fixture, from_term = 'protocol', sub_from = 'bgpaas', to_term = 'community', sub_to = '64512:55555')
    ...
    def test_rp_service_interface_matrix(self):
        ...
        self.configure_term_routing_policy(vn_fixture = left_vn_fixture, from_term = 'protocol', sub_from = 'service-interface', to_term = 'med', sub_to = '444')
        ...
        self.configure_term_routing_policy(vn_fixture = left_vn_fixture, from_term = 'protocol', sub_from = 'service-interface', to_term = 'local-preference', sub_to = '555')
        ...
        self.configure_term_routing_policy(vn_fixture = left_vn_fixture, from_term = 'protocol', sub_from = 'service-interface', to_term = 'as-path', sub_to = '666')
