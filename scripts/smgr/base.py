...
#    def setUp(self):
#        super(ServerManagerTest, self).setUp()
#        if 'PARAMS_FILE' in os.environ:
#            self.ini_file = os.environ.get('PARAMS_FILE')
#        else:
#            self.ini_file = 'sanity_params.ini'
...
#    def tearDown(self):
#        super(ServerManagerTest, self).tearDown()
...
'''
    def setUp(self):
        ...
        self.verify()
        self.logger.info("Finished configuring setup for smgr tests.")
        return self
'''
'''
    def setup(self):
