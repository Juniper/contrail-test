...
class TestPbbEvpnBridgeDomainConfig(PbbEvpnTestBase):
    ...
    def test_swap_isids_on_bds(self):
        ...
        vn = PBB_RESOURCES_2_BD['vn']
        bd = PBB_RESOURCES_2_BD['bd']
        vmi = PBB_RESOURCES_2_BD['vmi']
        vm = PBB_RESOURCES_2_BD['vm']
        traffic = PBB_RESOURCES_2_BD['traffic']
        bd_vmi_mapping = PBB_RESOURCES_2_BD['bd_vmi_mapping']
