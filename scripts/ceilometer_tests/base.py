...
#TO : Will enable later when testing with floating ip
...
#        assert self.vm1_fixture.ping_to_ip('8.8.8.8',count = '200')
...
class CeilometerTestResource (BaseResource): 
    ...
    def setUp(self,inputs,connections):
        super(CeilometerTestResource , self).setUp(inputs,connections)
