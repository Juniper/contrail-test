...
class PolicyTestBasicConfig_1():
    def __init__(self):
        ...
        self.policy_list= []; self.vn_subnets= {}
        self.vn_policy= {}; self.vn_of_cn= {}
        self.vm_of_cn= {}; self.vn_of_vm= {}
        begin_oct= 10; base_net= '.1.1.0/24'
        numEntity= 1; numRules= 4
        ...
        # There can be multple policies for a VN, build the list of policies by VN
        self.policy_vn= {}
