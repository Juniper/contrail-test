...
class sdn_multiple_vn_vm_basic_config ():
    def __init__(self, domain= 'default-domain', project= 'admin', username= None, password= None):
        ...
        self.rules['policy0']= [{'direction': '<>', 'protocol': 'any', 'dest_network': 'vnet0', 'source_network': 'vnet1', 'dst_ports': 'any', 'simple_action': 'pass', 'src_ports': 'any'} ]
        self.rules['policy1']= [{'direction': '<>', 'protocol': 'any', 'dest_network': 'any', 'source_network': 'any', 'dst_ports': 'any', 'simple_action': 'pass', 'src_ports': 'any'}]
...
if __name__ == '__main__':
    ...
    my_topo= sdn_multiple_vn_vm_basic_config(domain= 'default-domain', project= 'admin')
    x= my_topo.__dict__
