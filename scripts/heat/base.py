...
class BaseHeatTest(test_v1.BaseTestCase_v1):
    ...
    def config_svc_template(self, stack_name=None, scaling=False, mode='in-network-nat'):
        ...
        st = self.verify_st(env, scaling, nomgmt)
        return st
    # end config_svc_template

    def verify_st(self, env, scaling, nomgmt):
    ...
    def config_svc_instance(self, stack_name, st_fix, vn_list, max_inst=1):
        ...
        si_fix = self.verify_si(si_hs_obj.heat_client_obj, stack_name, si_name, st_fix, max_inst, st_fix.svc_mode, st_fix.image_name, ver)
    ...
    def verify_si(self, stack, stack_name, si_name, st_fix, max_inst, svc_mode, image, ver):
        svc_inst = self.useFixture(SvcInstanceFixture(
            ...
            svc_template=st_fix.st_obj, if_list=st_fix.if_list, version=ver))
