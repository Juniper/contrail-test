...
#    suite.addTest(AnalyticsTestSanity('test_delete_vm_and_verify_vm_uve_and_uve_cross_verification'))
    ...
    suite.addTest(AnalyticsTestSanity('test_verify__bgp_router_uve_up_xmpp_and_bgp_count'))
    suite.addTest(AnalyticsTestSanity('test_verify_connected_networks_based_on_policy'))
