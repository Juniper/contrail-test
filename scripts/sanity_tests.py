...
#    os.environ['SCRIPT_TS']= time.strftime("%Y%m%d%H%M%S")
    ...
    suite.addTest(TestSanityFixture('test_process_restart_in_policy_between_vns'))
    ...
    suite.addTest(TestSanityFixture('test_ping_within_vn_two_vms_two_different_subnets'))
