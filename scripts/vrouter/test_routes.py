...
class TestRoutes(BaseVrouterTest):
    ...
    def test_rt_table_scenario_1(self):
        ...
        vm1_fixture.cleanUp()
        self._remove_fixture_from_cleanup(vm1_fixture.cleanUp)
    ...
    def test_rt_table_scenario_3(self):
        ...
        vm3_fixture.cleanUp()
        self._remove_fixture_from_cleanup(vm3_fixture.cleanUp)
        self.del_interface_route_table(port2_fixture, intf_rtb_fixture.uuid)
    ...
    def test_rt_table_scenario_4(self):
        ...
        vm2_fixture.cleanUp()
        self._remove_fixture_from_cleanup(vm2_fixture.cleanUp)
