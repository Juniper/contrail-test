...
class SolnSetup(fixtures.Fixture, ConfigSvcChain,VerifySvcChain):
	...
	###Adding  the service chaining resources for firewall  ###
        ...
        self.vn1_policy_fix = self.attach_policy_to_vn(self.policy_fixtures, self.vn1_fixture)
        self.vn2_policy_fix = self.attach_policy_to_vn(self.policy_fixtures, self.vn2_fixture)
