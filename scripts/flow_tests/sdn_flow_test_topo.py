...
class sdn_flow_test_topo_multi_project ():
    def __init__(self, domain= 'default-domain', compute_node_list= None):
        ...
        #compute node or else leave empty.
        #self.vm_node_map = {}
        self.vm_node_map = {'vmc1':'CN0', 'vmc2':'CN0', 'vmc3':'CN0', 'vmc4':'CN0', 'vmd12':'CN0',
                            'vmc5':'CN1', 'vmc6':'CN1', 'vmc7':'CN1', 'vmd13':'CN1',
                            'vmc8':'CN2', 'vmc9':'CN2', 'vmd10':'CN2', 'vmd11':'CN2'}
        ...
        ##
        # Define traffic profile.
        self.traffic_profile= {'TrafficProfile1':{'src_vm':'vmc1', 'dst_vm':'vmc2', 'num_flows':300000, 'num_pkts':2000000},
    ...
    def build_topo_project1 (self, domain= 'default-domain', project= 'project1', username= 'juniper', password= 'juniper123'):
        ...
        ##
        # Define static route behind vms.
        self.vm_static_route= {'vmc1':'111.1.1.0/28', 'vmc2':'111.2.1.0/28', 'vmc3':'111.3.1.0/28', 'vmc4':'111.4.1.0/28', 'vmc7':'111.7.1.0/28'}
        self.vm_static_route_test.update(self.vm_static_route)
    ...
    def build_topo_project2 (self, domain= 'default-domain', project= 'project2', username= None, password= None):
        ...
        # Define network policy rules
        self.rules= {}
        self.rules['policy3']= [{'direction': '<>', 'protocol': 'udp', 'dest_network': 'default-domain:project1:vnet4', 'source_network': 'default-domain:project2:vnet7', 'dst_ports': 'any', 'simple_action': 'pass', 'src_ports': 'any'}]
        return self
