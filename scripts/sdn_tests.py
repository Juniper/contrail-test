...
class sdnTrafficTest(testtools.TestCase, fixtures.TestWithFixtures):
    ...
    def test_traffic_across_projects(self):
        ...
        for nodes in self.inputs.compute_ips:
        ...
        topo_obj= topology_class_name(compute_node_list=self.node_list)
        ###
    ...
    def test_policy_with_scaled_udp_18k_flows_900persec_setup_only(self):
        ...
        vms_per_compute= 2; num_streams= 180; flow_rate= 900
        ...
        return self.policy_test_with_scaled_udp_flows (topo, num_udp_streams= num_streams, pps= flow_rate, \
