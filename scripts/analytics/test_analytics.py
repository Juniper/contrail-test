...
#        vm_fixture_list=[self.res.vn1_vm1_fixture,self.res.vn1_vm2_fixture,self.res.vn1_vm3_fixture,
#                                                  self.res.vn1_vm4_fixture,self.res.vn2_vm1_fixture,
...
#        self.res.fvn_vm1_fixture.install_pkg("Traffic")
    ...
    @preposttest_wrapper
    def itest_verify_analytics_process_restarts(self):
    ...
    @preposttest_wrapper
    def itest_verify_opserver_connection_on_process_restarts_controlnode(self):
        ''' Test to validate process restarts
    ...
    @preposttest_wrapper
    def itest_verify_opserver_connection_on_process_restarts_compute_node(self):
