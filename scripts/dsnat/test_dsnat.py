...
class TestDSNAT(BaseDSNAT):
    ...
    def test_dsnat_basic(self):
        ...
        assert test_vm1.ping_with_certainty(EXTERNAL_IP)
        ...
        assert test_vm1.ping_with_certainty(test_vm2.vm_ip)
        assert test_vm1.ping_with_certainty(EXTERNAL_IP,expectation=False)
    ...
    def test_dsnat_with_policy(self):
        ...
        assert vm1_fixture.ping_with_certainty(EXTERNAL_IP), (
        ...
        assert vm1_fixture.ping_with_certainty(EXTERNAL_IP, expectation=False), (
    ...
    def test_dsnat_with_floating_ip(self):
        ...
        prefixes = []
        prefixes.append(EXTERNAL_IP+'/32')
