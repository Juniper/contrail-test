...
class TestDiscovery1(BaseDiscoveryTest):

    @classmethod
    def setUpClass(cls):
        super(TestDiscovery1, cls).setUpClass()
...
class TestDiscovery2(BaseDiscoveryTest):

    @classmethod
    def setUpClass(cls):
        super(TestDiscovery2, cls).setUpClass()
...
class TestDiscovery3(BaseDiscoveryTest):

    @classmethod
    def setUpClass(cls):
        super(TestDiscovery3, cls).setUpClass()
    ...
    @preposttest_wrapper
    def itest_change_parameters_in_discovery_conf(self):
