...
class sdn_3vn_3vm_config ():
    ...
    def __init__(self, domain='default-domain', project='admin', username=None, password=None):
        ...
        #
        # Define network info for each VN:
        self.vn_nets = {'vnet0': ['10.1.1.0/30', '11.1.1.0/30'], 'vnet1':
                        ['12.1.1.0/30', '13.1.1.0/30'], 'vnet2': ['14.1.1.0/30']}
        #
        # Define network policies
...
class sdn_20vn_20vm_config ():
    ...
    def __init__(self, domain='default-domain', project='admin', username=None, password=None):
        ...
        # Define network info for each VN:
        self.vn_nets = {
            'vnet18': ['46.1.1.0/30', '47.1.1.0/30'], 'vnet19': ['48.1.1.0/30', '49.1.1.0/30'], 'vnet12': ['34.1.1.0/30', '35.1.1.0/30'], 'vnet13': ['36.1.1.0/30', '37.1.1.0/30'], 'vnet10': ['30.1.1.0/30', '31.1.1.0/30'], 'vnet11': ['32.1.1.0/30', '33.1.1.0/30'], 'vnet16': ['42.1.1.0/30', '43.1.1.0/30'], 'vnet17': ['44.1.1.0/30', '45.1.1.0/30'], 'vnet14': ['38.1.1.0/30', '39.1.1.0/30'], 'vnet15': ['40.1.1.0/30', '41.1.1.0/30'],
            'vnet0': ['10.1.1.0/30', '11.1.1.0/30'], 'vnet1': ['12.1.1.0/30', '13.1.1.0/30'], 'vnet2': ['14.1.1.0/30', '15.1.1.0/30'], 'vnet3': ['16.1.1.0/30', '17.1.1.0/30'], 'vnet4': ['18.1.1.0/30', '19.1.1.0/30'], 'vnet5': ['20.1.1.0/30', '21.1.1.0/30'], 'vnet6': ['22.1.1.0/30', '23.1.1.0/30'], 'vnet7': ['24.1.1.0/30', '25.1.1.0/30'], 'vnet8': ['26.1.1.0/30', '27.1.1.0/30'], 'vnet9': ['28.1.1.0/30', '29.1.1.0/30']}
        #
        # Define network policies
        self.policy_list = [
