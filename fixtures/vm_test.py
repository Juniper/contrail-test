...
class VMFixture(fixtures.Fixture):
    ...
    def __init__(self, connections, vm_name=None, vn_obj=None,
                 vn_objs=None, project_name=None,
                 image_name='ubuntu', subnets=None, flavor=None,
                 node_name=None, sg_ids=None, count=1, userdata=None,
                 port_ids=None, fixed_ips=None, zone=None, vn_ids=None,
                 uuid=None, hc_uuids=None):
        vn_objs = vn_objs or []
        vn_ids = vn_ids or []
