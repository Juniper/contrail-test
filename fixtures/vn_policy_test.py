...
class VN_Policy_Fixture(fixtures.Fixture):
    ...
    def __init__(self, connections, vn_name, vn_obj, vn_policys, project_name, options='openstack', policy_obj=[],type='network'):
        ...
        if policy_of_vn:
            ...
            if self.policy_obj[self.vn]:
                ...
                if self.option == 'vro':
                    ...
                    if self.type == 'multicast':
                        self.orch.add_multicast_policy_to_vn(self.vn,policy_names)
                    else:
        ...
        if self.policy_obj[self.vn]:
            ...
            if policy_of_vn:
                if self.option == 'vro':
                    policy_names = [policy.name for policy in self.policy_obj[self.vn]]
                    if self.type == 'multicast':
                        self.orch.remove_multicast_policy_from_vn(self.vn,policy_names)
                    else:
