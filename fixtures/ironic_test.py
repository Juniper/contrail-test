...
class IronicHelper(object):
    ...
    def setUp(self):
        ...
        self.obj.http_client.api_version_select_state = self.ironic_api_config.get('api_version_select_state','user')
        self.obj.http_client.os_ironic_api_version = self.ironic_api_config.get('os_ironic_api_version','1.31')
    # end setUp
