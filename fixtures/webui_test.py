...
class WebuiTest:
    ...
    def create_ipam(self, fixture):
        ...
        '''
        self.browser.find_element_by_id(
            's2id_dns_method_dropdown').find_element_by_class_name(
            'select2-choice').click()
        dns_method_list = self.browser.find_element_by_id(
            'select2-drop').find_elements_by_tag_name('li')
        ...
        for dns in dns_list :
            ...
            if dns_text.find('Tenant') != -1 :
                ...
                if dns_text == 'Tenant':
                    ...
                    self.browser.find_element_by_id(
                        'virtual_dns_server_name').find_element_by_tag_name(
                        'a').click()
                    self.ui.wait_till_ajax_done(self.browser)
                    virtual_dns_list = self.browser.find_element_by_id(
                        'select2-drop').find_elements_by_tag_name('li')
