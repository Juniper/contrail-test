...
# ipam_fq_name=None, option = 'api'):
    ...
    def __init__(self, connections, vn_name, inputs, policy_objs=[], subnets=[], project_name='admin', router_asn='64512', rt_number=None, ipam_fq_name=None, option='quantum', forwarding_mode=None, vxlan_id=None, shared=False, router=False, clean_up=True):
        ...
        try:
            ...
            if not self.obj:
                self.obj = self.quantum_fixture.create_network(
                    self.vn_name, self.vn_subnets, self.ipam_fq_name, self.shared, self.router)
