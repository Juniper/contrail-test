...
class ContrailVncApi(object):
    ...
    def set_port_translation_pool(self, pp=[]):
        try:
            gv_obj = self.read_global_vrouter_config()
            ...
            self._log.error("Error in setting the port transation pools: %s" %(
                pp))
            return False
    ...
    def delete_port_translation_pool(self, pp):
        try:
            ...
            self._log.error("Error while deleting the port transation pools: %s" %(
                pp))
            return False
    ...
    def insert_port_translation_pool(self, pp, index=-1):
        try:
            ...
            self._log.error("Failed to insert the port transation pools: %s" %(
                pp))
            return False
