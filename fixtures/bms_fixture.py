...
class BMSFixture(fixtures.Fixture):
    ...
    def is_bonding_up(self, interfaces, verify_lacp=False, expectation=True):
        output = self.run("cat /proc/net/bonding/bond0")
    ...
    def delete_bonding(self):
        # ToDo: Need to skip deletion of bond0 if it has other subinterfaces
    ...
    def create_bonding(self, interfaces=None):
        ...
        self.run('modprobe -r bonding; modprobe bonding mode=802.3ad lacp_rate=fast')
