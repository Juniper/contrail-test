...
class PhysicalRouterFixture(VncLibFixture):
    ...
    :param name   : Mandatory, name of the device
    :param mgmt_ip  : Mandatory, Management IP
    ...
    def create_bgp_router(self):
        bgp_router = BgpRouter(self.name, parent_obj=self._get_ip_fabric_ri_obj())
