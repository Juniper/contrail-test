...
class FloatingIPFixture(fixtures.Fixture):
    ...
    def __init__(self, inputs, vn_id, connections, pool_name, vn_name=None, project_name='admin', option=None):
