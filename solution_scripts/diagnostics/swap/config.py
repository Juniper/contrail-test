...
def retrieve_configured_tenant_list(*args,**kwargs):
    ...
    try:
       obj = Project(None)
       obj.get_connection_handle()
       projects_list = obj.connections.vnc_lib.projects_list()['projects']
       ...
       tenant_name_list = sorted_nicely(tenant_name_list)
          ...
          pass
    if return_dict is not None:
       return_dict['value'] = tenant_name_list
...
def retrieve_vm_info(*args,**kwargs):
    ...
    tenant_name_list = generate_tenant_name_list(tenant_conf=tenant_conf,tenant_name=tenant_name)
    tenant_info = {}
