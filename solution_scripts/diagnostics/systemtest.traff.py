...
import  yaml
from config_traffic import *
from config_traffic import Project as ConfigProject
...
class Test(object):
    ...
    def parse_config(self):
        ...
        if tenant_traffic_block:
           self.traffic_conf['duration'] = tenant_traffic_block['duration']
           self.traffic_conf['external_server_ip'] = tenant_traffic_block['external_server']['ip']
           self.traffic_conf['pvn_ext_port'] = tenant_traffic_block['external_server']['pvn_ext_port']
           self.traffic_conf['snat_ext_port'] = tenant_traffic_block['external_server']['snat_ext_port']
           self.traffic_conf['ping'] = tenant_traffic_block['commands']['client_comm']['c_ping']
