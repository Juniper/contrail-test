...
class Test(object):
    ...
    def get_vm_info(self,tenant_name):
        ...
        return retrieve_vm_info(tenant_name=tenant_name,global_conf=self.global_conf,tenant_conf=self.tenant_conf)
    ...
    def parse_config(self):
        ...
        if tenant_traffic_block:
           ...
           self.traffic_conf['snat_ext_port_start'] = int(tenant_traffic_block['external_server']['snat_ext_port_start'])
           ...
           self.traffic_conf['s_iperf3'] = tenant_traffic_block['server_comm']['s_iperf3'] + ["-t", str(int(tenant_traffic_block['duration'])+120)]
