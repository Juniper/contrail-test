...
class VN(Base):
    ...
    @timeit
    def create_vns(self,admin_conn_obj_list,proj_conn_obj_list,thread_count,global_conf,tenant_conf,tenant_list,update_properties):
        kwargs_list = []
...
class VM(Base):
    ...
    def create(self,connections,name, data_vn_obj,mgmt_vn_obj,additional_vn_obj_list,vn_id_dict,subnet_id_dict,mgmt_network_first,image='ubuntu',userdata=None,flavor="m1.small",zone=None):
        ...
        if subnet_id_dict['mgmt'] :
           ...
           mgmt_port = fixture.quantum_h.create_port(mgmt_vn_id,mgmt_subnet_id)
           data_port = fixture.quantum_h.create_port(data_vn_id,data_subnet_id)
    ...
    @timeit
    def create_vms(self,admin_conn_obj_list,proj_conn_obj_list,thread_count,global_conf,tenant_conf,tenant_list,update_properties,dpdk):
        kwargs = {}
...
class RouterConfig(Base):
      ...
      def create_physical_routers(self,conn_obj_list,thread_count,global_conf,tenant_conf,update_properties=False):
          ...
          if len(kwargs_list) == 0:
             return
          self.create_physical_router(tcount=thread_count,conn_obj_list=conn_obj_list,kwargs_list=kwargs_list)
