...
#   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.ipv4.v2.yaml --delete --tenant_count 1 --tenant_index_range 80:80 --global_yaml_config_file diagnostics/csol1.global.yaml
#  python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.ipv4.v2.yaml --create --tenant_count 1 --tenant_index_range 80:80 --global_yaml_config_file diagnostics/csol1.global.yaml
#exit
