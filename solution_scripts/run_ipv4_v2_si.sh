...
export PYTHONPATH=$CONTRAIL_TEST_CI:$CONTRAIL_TEST_CI/scripts/:$CONTRAIL_TEST_CI/fixtures/:/usr/local/lib/python2.7/dist-packages/:/usr/lib/python2.7/dist-packages/:$CONTRAIL_TEST_CI/tcutils/:$CONTRAIL_TEST_CI/common/:./
 #python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.ipv4.v2.yaml --tenant_count 1 --tenant_index_range 81:81 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only --feature_ping_only
#exit

rm logs/tor-scale.log.log
while true;
do
 python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.ipv4.v2.yaml --delete --tenant_count 1 --tenant_index_range 82:82 --global_yaml_config_file diagnostics/csol1.global.yaml
 python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.ipv4.v2.yaml --create --tenant_count 1 --tenant_index_range 82:82 --global_yaml_config_file diagnostics/csol1.global.yaml
exit
#python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/simple1.yaml --tenant_count 1 --tenant_index_range 80:80 --global_yaml_config_file diagnostics/csol2.global.yaml --print_mgmt_ip
# sh configure_mgmt_ip.sh symantecTenant80_mgmt_ip.txt
 python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.ipv4.v2.yaml --tenant_count 1 --tenant_index_range 80:80 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only --feature_ping_only
exit
done
exit
while true;
