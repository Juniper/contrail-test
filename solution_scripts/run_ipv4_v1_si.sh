...
rm logs/tor-scale.log.log
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.v4.v1.yaml --delete --tenant_count 1 --tenant_index_range 45:45 --global_yaml_config_file diagnostics/csol1.global.yaml
exit
  python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.v4.v1.yaml --create --tenant_count 1 --tenant_index_range 45:45 --global_yaml_config_file diagnostics/csol1.global.yaml
#exit
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.v4.v1.yaml --tenant_count 1 --tenant_index_range 45:45 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only --feature_ping_only
exit
