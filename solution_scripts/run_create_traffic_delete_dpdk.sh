...
#python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.full.yaml --delete --tenant_count 1 --tenant_index_range 10:10 --global_yaml_config_file diagnostics/csol1.global.dpdk.yaml
#python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.full.yaml --create --tenant_count 1 --tenant_index_range 10:10 --global_yaml_config_file diagnostics/csol1.global.dpdk.yaml --dpdk
#exit
