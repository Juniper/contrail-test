...
#python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.ipv6.v2.yaml --tenant_count 1 --tenant_index_range 90:90 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only --feature_ping_only
#exit
rm ping_result_symantec.Tenant90.txt
while true;
do
python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.ipv6.v2.yaml --delete --tenant_count 1 --tenant_index_range 90:90 --global_yaml_config_file diagnostics/csol1.global.yaml
python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.ipv6.v2.yaml --create --tenant_count 1 --tenant_index_range 90:90 --global_yaml_config_file diagnostics/csol1.global.yaml
#   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.ipv6.v2.yaml --tenant_count 1 --tenant_index_range 90:90 --global_yaml_config_file diagnostics/csol2.global.yaml --print_mgmt_ip
#   sh configure_mgmt_ip.sh symantecTenant90_mgmt_ip.txt
python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.ipv6.v2.yaml --tenant_count 1 --tenant_index_range 90:90 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only --feature_ping_only
exit
done
exit
