...
class sdn_flow_test_topo_single_project ():
    ...
    def build_topo_project1(self, domain='default-domain', project='project1', username='juniper', password='juniper123'):
        ...
        # created.
        self.fvn_vm_map = {'vnet3': ['vmc6', 'vmc8'],
                           'vnet4': ['vmc5'], 'vnet5': ['vmc5']}
...
class sdn_flow_test_topo_multi_project ():
    ...
    def __init__(self, domain='default-domain', compute_node_list=None):
        ...
        #self.vm_node_map = {}
        self.vm_node_map = {
            'vmc1': 'CN0', 'vmc2': 'CN0', 'vmc3': 'CN0', 'vmc4': 'CN0', 'vmd12': 'CN0',
    ...
    def build_topo_project2(self, domain='default-domain', project='project2', username=None, password=None):
        ...
        self.rules = {}
        self.rules[
            'policy3'] = [{'direction': '<>', 'protocol': 'udp', 'dest_network': 'default-domain:project1:vnet4',
