...
class systest_topo_single_project ():
    ...
    def __init__(self, compute_node_list=None, domain='default-domain', project=None, username=None, password=None):
        ...
        self.traffic_profile = {'TrafficProfile1': {'src_vm': 'vmc1', 'dst_vm': 'vmc2', 'num_flows': 9000, 'num_pkts': 90000}}
        #
    ...
    def build_topo_project2(self, domain='default-domain', project='project2', username='juniper', password='juniper123'):
        ...
        self.rules = {}
        self.rules['policy1'] = [
            {'direction': '<>', 'protocol': 'udp', 'dest_network': 'default-domain:project2:vnet1', 'source_network': 'local', 'dst_ports': 'any', 'simple_action': 'pass', 'src_ports': 'any'}]
