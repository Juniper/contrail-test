...
class systest_topo_single_project ():
    ...
    def build_topo_project2(self, domain='default-domain', project='project2', username='juniper', password='juniper123'):
        ...
        self.vn_nets = {
            ...
            'vnet2': ['10.2.1.0/30', '10.2.1.4/30'], 'vnet3': ['10.3.1.0/30', '10.3.1.4/30', '10.3.1.8/30'],
            'vnet4': ['10.4.1.0/30', '10.4.1.4/30', '10.5.1.8/30'], 
            'vnet5': ['10.5.1.0/30', '10.5.1.4/30', '10.5.1.8/30'], 'vnet6': ['10.6.1.0/30', '10.6.1.4/30']}
        #
        ...
        # Not defining service instances for flow rate testing 
        ...
        self.rules['policy1'] = [
            ...
            {'direction': '<>', 'protocol': 'udp', 'dest_network': 'default-domain:project2:vnet1', 'source_network': 
                'default-domain:project2:vnet2', 'dst_ports': 'any', 'simple_action': 'pass', 'src_ports': 'any'}]
