...
while true;
do
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/lbaasv2.yaml --delete --tenant_count 1 --tenant_index_range 12:12 --global_yaml_config_file diagnostics/csol1.global.yaml
   #exit
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/lbaasv2.yaml --create --tenant_count 1 --tenant_index_range 12:12 --global_yaml_config_file diagnostics/csol1.global.yaml
      python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/simple1.yaml --tenant_count 1 --tenant_index_range 12:12 --global_yaml_config_file diagnostics/csol2.global.yaml --print_mgmt_ip
      sh configure_mgmt_ip.sh symantecTenant12_mgmt_ip.txt
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/lbaasv2.yaml --tenant_count 1 --tenant_index_range 12:12 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only #--feature_ping_only
done
exit
while true;
do
