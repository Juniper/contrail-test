...
#python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.ipv6.v1.yaml --create --tenant_count 1 --tenant_index_range 70:70 --global_yaml_config_file diagnostics/csol1.global.yaml
#exit
python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.ipv6.v1.yaml --tenant_count 1 --tenant_index_range 70:70 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only #--feature_ping_only
