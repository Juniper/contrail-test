...
exit
python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.simple.yaml --create --tenant_count 1 --tenant_index_range 25:25 --global_yaml_config_file diagnostics/csol1.global.yaml
exit
python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.simple.yaml --tenant_count 1 --tenant_index_range 25:25 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only 
exit
