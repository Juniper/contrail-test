...
#python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file simple_yaml/symantec.simple.yaml --delete --tenant_count 1 --tenant_index_range 11:11 --global_yaml_config_file diagnostics/csol1.global.yaml
#exit
#python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file simple_yaml/symantec.simple.yaml --create --tenant_count 1 --tenant_index_range 11:11 --global_yaml_config_file diagnostics/csol1.global.yaml
#exit
python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file simple_yaml/symantec.simple.yaml --tenant_count 1 --tenant_index_range 11:11 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only --feature_ping_only
exit
