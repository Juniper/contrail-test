...
while true;
do
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.ipv4.v2.yaml --delete --tenant_count 1 --tenant_index_range 60:60 --global_yaml_config_file diagnostics/csol1.global.yaml
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.update1.yaml --create --tenant_count 1 --tenant_index_range 60:60 --global_yaml_config_file diagnostics/csol1.global.yaml
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.update1.yaml --tenant_count 1 --tenant_index_range 60:60 --global_yaml_config_file diagnostics/csol1.global.yaml --print_mgmt_ip
   sh configure_mgmt_ip.sh symantecTenant60_mgmt_ip.txt
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.update1.yaml --tenant_count 1 --tenant_index_range 60:60 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.update2.yaml --update --tenant_count 1 --tenant_index_range 60:60 --global_yaml_config_file diagnostics/csol1.global.yaml
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.update2.yaml --tenant_count 1 --tenant_index_range 60:60 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only
done
exit
