...
export PYTHONPATH=$CONTRAIL_TEST_CI:$CONTRAIL_TEST_CI/scripts/:$CONTRAIL_TEST_CI/fixtures/:/usr/local/lib/python2.7/dist-packages/:/usr/lib/python2.7/dist-packages/:$CONTRAIL_TEST_CI/tcutils/:$CONTRAIL_TEST_CI/common/:./
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.fat.yaml --tenant_count 1 --tenant_index_range 40:40 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only --feature_ping_only
exit

   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.fat.yaml  --delete --tenant_count 1 --tenant_index_range 40:40 --global_yaml_config_file diagnostics/csol1.global.yaml
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.fat.yaml --create --tenant_count 1 --tenant_index_range 40:40 --global_yaml_config_file diagnostics/csol1.global.yaml
   #python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.fat.yaml --tenant_count 1 --tenant_index_range 40:40 --global_yaml_config_file diagnostics/csol2.global.yaml --print_mgmt_ip
   #sh configure_mgmt_ip.sh symantecTenant40_mgmt_ip.txt
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.fat.yaml --tenant_count 1 --tenant_index_range 40:40 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only --feature_ping_only
exit
while true;
do
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.fat.yaml --tenant_count 1 --tenant_index_range 40:40 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only
done
exit
while true;
do
   ...
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.v4.v1.yaml --create --tenant_count 1 --tenant_index_range 40:40 --global_yaml_config_file diagnostics/csol1.global.yaml --dpdk
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.v4.v1.yaml --tenant_count 1 --tenant_index_range 40:40 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only
done
exit
