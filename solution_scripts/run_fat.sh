...
#   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.fat.yaml --create --tenant_count 1 --tenant_index_range 40:40 --global_yaml_config_file diagnostics/csol1.global.yaml --dpdk
