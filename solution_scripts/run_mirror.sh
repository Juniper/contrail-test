...
while true;
do
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/mirror.yaml --delete --tenant_count 1 --tenant_index_range 80:80 --global_yaml_config_file diagnostics/csol1.global.yaml
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/mirror.yaml --create --tenant_count 1 --tenant_index_range 80:80 --global_yaml_config_file diagnostics/csol1.global.yaml --dpdk
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/mirror.yaml --tenant_count 1 --tenant_index_range 80:80 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only
done
exit
while true;
do
