...
#   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/mirror.yaml --delete --tenant_count 1 --tenant_index_range 95:95 --global_yaml_config_file diagnostics/csol1.global.yaml
#  python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/mirror.yaml --create --tenant_count 1 --tenant_index_range 95:95 --global_yaml_config_file diagnostics/csol1.global.yaml 
#  exit
#   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/mirror.yaml --tenant_count 1 --tenant_index_range 95:95 --global_yaml_config_file diagnostics/csol1.global.yaml --print_mgmt_ip
#   sh configure_mgmt_ip.sh symantecTenant95_mgmt_ip.txt
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/mirror.yaml --tenant_count 1 --tenant_index_range 95:95 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only
exit
#   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/mirror.yaml --tenant_count 1 --tenant_index_range 95:95 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only --feature_ping_only

exit
while true;
do
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/mirror.yaml --delete --tenant_count 1 --tenant_index_range 90:90 --global_yaml_config_file diagnostics/csol1.global.yaml
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/mirror.yaml --create --tenant_count 1 --tenant_index_range 90:90 --global_yaml_config_file diagnostics/csol1.global.yaml --dpdk
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/mirror.yaml --tenant_count 1 --tenant_index_range 90:90 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only
done
exit
while true;
do
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.v4.v1.yaml --delete --tenant_count 1 --tenant_index_range 30:30 --global_yaml_config_file diagnostics/csol1.global.yaml
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.v4.v1.yaml --create --tenant_count 1 --tenant_index_range 30:30 --global_yaml_config_file diagnostics/csol1.global.yaml --dpdk
   python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.tor2.si.v4.v1.yaml --tenant_count 1 --tenant_index_range 30:30 --global_yaml_config_file diagnostics/csol1.global.yaml --traffic_only
done
exit
