...
class TestvDNSRestart(BasevDNSTest):
    ...
    def test_vdns_with_same_zone(self):
        ...
        for proj in project_list:
            ...
            # Ipam creation
            ipam_fixt[proj] = self.useFixture(IPAMFixture(ipam_list[proj], vdns_obj= vdns_fixt1[proj].obj,
            ...
            vn_quantum_obj = self.orch.get_vn_obj_if_present(vn_name=vn_list[proj], project_id=project_fixture.uuid)
            # VM creation
