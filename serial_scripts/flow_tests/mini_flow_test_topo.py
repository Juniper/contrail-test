...
class systest_topo_single_project ():
    ...
    def build_topo_project2(self, domain='default-domain', project='project2', username='juniper', password='juniper123'):
        ...
        self.rules = {}
        self.rules['policy1'] = [
            {'direction': '<>', 'protocol': 'udp', 'dest_network': 'default-domain:project2:vnet1', 
                'source_network': 'local', 'dst_ports': 'any', 'simple_action': 'pass', 'src_ports': 'any'}]
