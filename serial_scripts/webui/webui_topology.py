...
class sdn_webui_config ():
    ...
    def __init__(self, domain='default-domain', project='admin', username=None, password=None):
        ...
        self.vn_nets = {
            'left_vn': ['31.1.1.0/24'], 'right_vn': ['41.2.2.0/24'], 'vnet0': ['10.1.1.0/24', '11.1.1.0/24'],
            'vnet1': ['12.1.1.0/24', '13.1.1.0/24'], 'vnet2': ['14.1.1.0/24', '15.1.1.0/24'], 'vnet3': ['16.1.1.0/24', '17.1.1.0/24']}
        #
