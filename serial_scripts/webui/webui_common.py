        ...
        for row in rows_detail:
            ...
            if key == 'Graceful Restart':
                ...
                if key_value[0] == 'Enabled':
                    ...
                    webui_global_key_value.append({'key': 'BGP_Helper',
                                                 'value': timer_values[0]})
                    webui_global_key_value.append({'key': 'Restart_Time(secs)',
                                                 'value': timer_values[1]}),
                    webui_global_key_value.append({'key': 'LLGR_Time(secs)',
                                                 'value': timer_values[2]}),
                    webui_global_key_value.append({'key': 'End_of_RIB(secs)',
                                                 'value': timer_values[3]})
                continue
            if len(key_value) == 1:
