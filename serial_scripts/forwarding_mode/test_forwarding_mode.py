...
class TestForwardingMode(BaseForwardingMode):
    ...
    def test_forwarding_mode_l2(self):
        ...
        self.forwarding_mode = 'l2'
        return self.setup_commmon_objects(vn_name='vn_l2',vm_name1='vm1_l2',vm_name2='vm2_l2')
        
    @preposttest_wrapper
    def test_forwarding_mode_l3(self):
        '''Test to check traffic between VM's when forwarding_mode set to L3'''
        self.forwarding_mode = 'l3'
        return self.setup_commmon_objects(vn_name='vn_l3',vm_name1='vm1_l3',vm_name2='vm2_l3')
    ...
    def test_forwarding_mode_l2_l3(self):
        ...
        return self.setup_commmon_objects(vn_name='vn_l2_l3',vm_name1='vm1_l2_l3',vm_name2='vm2_l2_l3')
    ...
    def test_forwarding_mode_global_l2(self):
        ...
        result = self.setup_commmon_objects(vn_name='vn_global_l2',vm_name1='vm1_global_l2',vm_name2='vm2_global_l2')
        self.vnc_lib_fixture.set_global_forwarding_mode(None)
        return result
    ...
    def test_forwarding_mode_global_l3(self):
        ...
        self.vnc_lib_fixture.set_global_forwarding_mode(self.gl_forwarding_mode)
        result = self.setup_commmon_objects(vn_name='vn_global_l3',vm_name1='vm1_global_l3',vm_name2='vm2_global_l3')
        self.vnc_lib_fixture.set_global_forwarding_mode(None)
        return result
    ...
    def test_forwarding_mode_global_l2_l3(self):
        ...
        self.vnc_lib_fixture.set_global_forwarding_mode(self.gl_forwarding_mode)
        result = self.setup_commmon_objects(vn_name='vn_global_l2_l3',vm_name1='vm1_global_l2_l3',vm_name2='vm2_global_l2_l3')
        self.vnc_lib_fixture.set_global_forwarding_mode(None)
        return result
    
    def setup_commmon_objects(self,vn_name,vm_name1,vm_name2):
        vn_fixture = self.create_vn(vn_name=vn_name,forwarding_mode = self.forwarding_mode)
        vn_fixture.set_unknown_unicast_forwarding(enable=True)
        ...
        if  self.vnc_lib_fixture.get_active_forwarding_mode(vn_fixture.vn_fq_name) =='l2':
            self.logger.info("Skipping Ping Test between VM's")
        else:
            self.logger.info("Ping between VM's")
