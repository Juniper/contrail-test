...
class ConfigScaleSetup(convertor.ReadConfigIni):
    ...
    def __init__(self):
        ...
        #self.lib_handle=ConfigScale(self.inputs, self.logger, self.connections,  self.vnc_lib, self.auth)
    ...
    def config_one_tor(self, config_dict, tor_id):
        ...
        self.tor_dict, self.tor_info=self.lib_handle.get_tor_info(tor_id=tor_id)
        ...
        # Config project
        self.project_handle=self.lib_handle.create_project(project_name=self.lib_handle.get_project_name(config_dict,tor_id))
        self.lib_handle.create_and_attach_user_to_tenant(user=tor_id,password=tor_id)
            ...
            for lif in range(3, lif_count):
                ...
                if create_new_vn:
                    ...
                    self.vn_handle= self.lib_handle.create_vn(vn_name=self.lib_handle.get_vn_name(self.lib_handle.get_vxlan_id(config_dict,\
                                                              ...
                                                              vn_subnet= [self.lib_handle.get_subnet(config_dict,tor_id, num_lif_in_systems)], 
                                                              project_name=self.lib_handle.get_project_name(config_dict,tor_id), 
                ...
                create_new_vn=num_lif_in_systems%self.lib_handle.get_num_vmi_per_vn (config_dict,tor_id)
