...
class TestAsn4(ASN4Base,BaseBGPaaS,LocalASBase):
    ...
    def set_global_ibgp_mesh(self,state):

        gsc_obj = self.connections.vnc_lib.global_system_config_read(
                  fq_name=['default-global-system-config'])
        gsc_obj.set_ibgp_auto_mesh(state)
    ...
    def get_global_ibgp_mesh(self):
        
        gsc_obj = self.connections.vnc_lib.global_system_config_read(
                  fq_name=['default-global-system-config'])
        return gsc_obj.get_ibgp_auto_mesh()
    ...
    def config_basic(self):
        ...
        ret_dict = {'vn_fixture':vn_fixture,
                     'test_vm':vm1_fixture,
                     'bgpaas_vm1':vm2_fixture}
        return ret_dict

    def update_bgpaas_configuration(self,control_node_config,vm_config,vm_fixt,bgpaas_fixt):
    ...
    def reconfigure_bgpaas_vms(self,control_node_config,vn_fixture,vm_fixt_list,vm_config_list):
    ...
    def configure_control_nodes(self,control_node_config,mx_config):
        ...
        if not skip_control_node_config:
    ...
    def test_basic_as4_ibgp(self):
        ...
        self.test_basic_as4(topology_info,test_info)
    ...
    def test_basic_as4(self,topology_info,test_info):
        ...
        self.update_bgpaas_configuration(control_node_config=control_node_config,vm_config=vm_config_list[1],vm_fixt=vm_fixt_list[1],bgpaas_fixt=bgpaas_fixture_list[1])
        self.update_bgpaas_configuration(control_node_config=control_node_config,vm_config=vm_config_list[2],vm_fixt=vm_fixt_list[2],bgpaas_fixt=bgpaas_fixture_list[2])
        time.sleep(60)
        self.verify_bgpaas_bgp_routes(control_node_config=control_node_config,vn_fixture=vn_fixture,src_vm=vm_fixt_list[0],bgpaas_vm=vm_fixt_list[1],vm_config=vm_config_list[1],expected_routes=vsrx1_routes)
        self.verify_bgpaas_bgp_routes(control_node_config=control_node_config,vn_fixture=vn_fixture,src_vm=vm_fixt_list[0],bgpaas_vm=vm_fixt_list[2],vm_config=vm_config_list[1],expected_routes=vsrx2_routes)
        self.verify_received_routes_in_mx(mx_config,peer_ips=self.inputs.bgp_control_ips,expected_routes=mx_routes,bgp_type=bgp_type)
        ...
        self.configure_physical_devices(control_node_config,mx_config)
        self.reconfigure_bgpaas_vms(control_node_config=control_node_config,vn_fixture=vn_fixture,vm_fixt_list=vm_fixt_list,vm_config_list=vm_config_list)
