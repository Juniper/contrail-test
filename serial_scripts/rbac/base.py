...
class BaseRbac(test_v1.BaseTestCase_v1):
    ...
    def domain_acl_fq_name(self, domain='default-domain', acl_name='default-api-access-list'):
        acl_list = []
        acl_list.append(domain)
        acl_list.append(acl_name)
        return acl_list

    def global_acl_fq_name(self, global_acl='default-global-system-config', acl_name='default-api-access-list-3'):
        acl_list = []
        acl_list.append(global_acl)
        acl_list.append(acl_name)
        return acl_list
    ...
    def verify_vn_perms2_in_api_introp(self, vn_id):
       ...
       # introp_perms2 = vn_api.perms2()
        introp_perms2 = vn_api['virtual-network']['perms2']
