...
class TestECMPHash(BaseECMPRestartTest, VerifySvcFirewall, ECMPTraffic, ECMPVerify):
    ...
    def test_source_port(self):
        ...
        #Try different source-ports, making sure traffic doesn't switch each time
        for i in range(8001,8005):
            old_path_taken = self.send_traffic_and_return_path_taken(sender=self.left_vm_fixture, receiver=self.right_vm_fixture, sport=i, dport='9001', protocol ='udp')

            new_path_taken = self.send_traffic_and_return_path_taken(sender=self.left_vm_fixture, receiver=self.right_vm_fixture, sport=i, dport='9001', protocol ='udp')

            assert (old_path_taken == new_path_taken), 'Source port not in ecmp calculation, yet traffic switches over'
        ...
        for i in range(8002,8062):
            self.send_traffic_and_update_hit_count(sender=self.left_vm_fixture, receiver=self.right_vm_fixture, sport=i, dport='9001', protocol ='udp')
    ...
    def test_destination_port(self):
        ...
        #Try with different destination ports, making sure traffic doesn't switch
        for i in range(9001,9005):
            old_path_taken = self.send_traffic_and_return_path_taken(sender=self.left_vm_fixture, receiver=self.right_vm_fixture, sport='8001', dport=i, protocol ='udp')

            new_path_taken = self.send_traffic_and_return_path_taken(sender=self.left_vm_fixture, receiver=self.right_vm_fixture, sport='8001', dport=i, protocol ='udp')

            assert (old_path_taken == new_path_taken), 'Destination port not in ecmp calculation, yet traffic switches over'
        ...
        for i in range(9102,9162):
            self.send_traffic_and_update_hit_count(sender=self.left_vm_fixture, receiver=self.right_vm_fixture, sport='8001', dport=i, protocol ='udp')
    ...
    def test_destination_ip(self):
        ...
        #try with different destination-ips, making sure traffic doesn't switch
        for i in range(1,3):
            old_path_taken = self.send_traffic_and_return_path_taken(sender=self.left_vm_fixture, receiver=self.right_vm_fixture, sport='8001', dport='9001', protocol ='udp')

            new_path_taken = self.send_traffic_and_return_path_taken(sender=self.left_vm_fixture, receiver=self.vm4_fixture, sport='8001', dport='9001', protocol ='udp')

            assert (old_path_taken == new_path_taken), 'Destination ip not in ecmp calculation, yet traffic switches over'
        ...
        for i in range(1,30):
            self.send_traffic_and_update_hit_count(sender=self.left_vm_fixture, receiver=self.right_vm_fixture, sport='8001', dport='9001', protocol ='udp')

            self.send_traffic_and_update_hit_count(sender=self.left_vm_fixture, receiver=self.vm4_fixture, sport='8001', dport='9001', protocol ='udp')
    ...
    def test_source_ip(self):
        ...
        for i in range(1,3):
            ...
            new_path_taken = self.send_traffic_and_return_path_taken(sender=self.vm3_fixture, receiver=self.right_vm_fixture, sport='8001', dport='9001', protocol ='udp')

            assert (old_path_taken == new_path_taken), 'Source ip not in ecmp calculation, yet traffic switches over'
        ...
        for i in range(1,30):
            ...
            self.send_traffic_and_update_hit_count(sender=self.vm3_fixture, receiver=self.right_vm_fixture, sport='8001', dport='9001', protocol ='udp')
    ...
    def test_l4_protocol(self):
        ...
        #Send traffic with udp and tcp alternatively, making sure traffic doesn't switch
        for i in range(1,5):
            old_path_taken = self.send_traffic_and_return_path_taken(sender=self.left_vm_fixture, receiver=self.right_vm_fixture, sport='8001', dport='9001', protocol ='udp')

            new_path_taken = self.send_traffic_and_return_path_taken(sender=self.left_vm_fixture, receiver=self.right_vm_fixture, sport='8001', dport='9001', protocol ='tcp')
        ...
        #Send traffic with udp and tcp alternatively now. Display switch statistics
        for i in range(1,30):
            self.send_traffic_and_update_hit_count(sender=self.left_vm_fixture, receiver=self.right_vm_fixture, sport='8001', dport='9001', protocol ='udp')

            self.send_traffic_and_update_hit_count(sender=self.left_vm_fixture, receiver=self.right_vm_fixture, sport='8001', dport='9001', protocol ='tcp')
