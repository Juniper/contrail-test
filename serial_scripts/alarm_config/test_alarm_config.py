...
class TestAlarmConfigCases(BaseAlarmConfigTest,VerifyAlarms):
    ...
    def test_alarm_conf_in_global_config(self):
        ...
        exp_list = [exp1]
        update_list = [exp2]
        self.verify_alarm_config(exp_list=exp_list,update_list=update_list,parent_type='global')
    ...
    def test_alarm_conf_in_project(self):
        ...
        exp_list = [exp1]
        update_list = [exp2]
        self.verify_alarm_config(exp_list=exp_list,update_list=update_list,parent_type='project')
    ...
    def test_alarm_conf_with_multiple_rules_in_global_config(self):
        ...
        exp4 = {'operation': '>=','operand1': 'UveVirtualNetworkConfig.total_acl_rules','operand2':{'json_value': '3'}}
        exp_list = [exp1,exp2,exp3]
        update_list = [exp1,exp4,exp3]
        self.verify_alarm_config(exp_list=exp_list,update_list=update_list,parent_type='global',alarm_case='multi_condition')
    ...
    def test_alarm_conf_with_multiple_rules_in_project(self):
        ...
        exp_list = [exp1,exp2,exp3]
        update_list = [exp1,exp4,exp3]
        self.verify_alarm_config(exp_list=exp_list,update_list=update_list,parent_type='project',alarm_case='multi_condition')
    ...
    def test_alarm_conf_with_invalid_cases_in_global_config(self): 
        ...
        '''
        exp1 = {'operation': '<=','operand1': "UveVirtualNetworkConfig.total_acl_rules",'operand2':{'json_value': '2'}}
        self.verify_alarm_config(exp_list=[exp1],parent_type='global',alarm_case='invalid')
    ...
    def test_alarm_conf_with_invalid_cases_in_projects(self):
        ...
        exp1 = {'operation': '<=','operand1': "UveVirtualNetworkConfig.total_acl_rules",'operand2':{'json_value': '2'}}
        exp2= {'operation': '>==','operand1': 'UveVirtualNetworkConfig.total_acl_rules','operand2':{'json_value': '1'}}
        self.verify_alarm_config(exp_list=[exp1], update_list=[exp2],parent_type='project',alarm_case='invalid')
    ...
    def test_alarm_scaling_under_global_config(self):
        ...
        '''
        exp1 = {'operation': '<=','operand1': "UveVirtualNetworkConfig.total_acl_rules",'operand2':{'json_value': '2'}}
        self.verify_alarm_config(exp_list=[exp1],parent_type='global',alarm_case='scaling')
    ...
    def test_alarm_scaling_under_project(self):
        ...
        '''
        exp1 = {'operation': '<=','operand1': "UveVirtualNetworkConfig.total_acl_rules",'operand2':{'json_value': '2'}}
        self.verify_alarm_config(exp_list=[exp1],parent_type='project',alarm_case='scaling')
