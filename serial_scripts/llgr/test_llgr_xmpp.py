...
class TestLlgrXmpp(TestLlgrBase):
    ...
    def test_gr_xmpp_restart(self):
        ...
        self.inputs.restart_service('contrail-control', [self.inputs.bgp_ips[1]], container='controller') 
    ...
    def test_gr_agent_restart(self):
        ...
        self.inputs.restart_service('contrail-vrouter', self.inputs.compute_ips, container='agent') 
