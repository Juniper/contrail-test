...
class TestFabricEvpnType5(BaseFabricTest, VerifyEVPNType5):
    ...
    def test_evpn_type_5_vxlan_traffic_between_vn(self):
        ...
        bms1 = self.create_bms(bms_name=bms,
                vn_fixture=vn2,
                security_groups=[self.default_sg.uuid])
        lr1.verify_on_setup()
        lr2.verify_on_setup()
        ...
        self.do_ping_test(vm11, bms1)
        self.do_ping_test(vm2, bms1)
    ...
    def test_evpn_type_5_vm_to_bms_remove_vn_from_lr(self):
        ...
        self.sleep(30)
        self.do_ping_test(vm1, vm2, expectation=False)
        self.do_ping_test(vm1, bms1, expectation=False)
    ...
    def test_evpn_type_5_vm_to_bms_remove_vni_from_lr(self):
        ...
        self.sleep(30)
        self.do_ping_test(vm1, vm2, expectation=False)
        self.do_ping_test(bms1, vm1, expectation=False)
