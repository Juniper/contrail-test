...
lass TestService(BaseK8sTest):
    ...
    @preposttest_wrapper
    def test_docker_restart_on_slaves_with_multiple_nodeport_servoces_with_namespace_isolation(self):
        app = 'http_nodeport_test'
        labels = {'app': app}
    ...
    @preposttest_wrapper
    def test_vrouter_restart_on_slaves_with_multiple_nodeport_servoces_with_namespace_isolation(self):
        app = 'http_nodeport_test'
        labels = {'app': app}
        namespace1_name = get_random_name("ns1")
        namespace2_name = get_random_name("ns2")
    ...
    @preposttest_wrapper
    def test_kube_manager_restart_with_multiple_nodeport_servoces_with_namespace_isolation(self):
        app = 'http_nodeport_test'
        labels = {'app': app}
        namespace1_name = get_random_name("ns1")
        namespace2_name = get_random_name("ns2")
