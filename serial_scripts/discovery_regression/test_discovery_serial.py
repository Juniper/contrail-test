...
#            assert result
    ...
    def test_rule_when_service_admin_down(self):
        ''' Validate that when publisher mentioned in rule is administratively down, the subscriber mentioned in rule, do not subscribe to any other publisher.
            ...
            5. Verify that as soon as Publisher is made admin UP, the subscriber will get that instance of service.
        '''
        assert self.ds_obj.verify_rule_when_service_admin_down(
        )
    ...
    def test_auto_load_balance_xmpp(self):
        ''' Validate that auto load balance works correctly for XmppServer.
            This script also validates Bug 1395099 : Trigger subscription from discovery client for faster convergence
            Steps:
    ...
    def test_rule_do_not_affect_other_dns_subscriptions(self):
        ...
        '''
        assert self.ds_obj.verify_rule_do_not_affect_other_dns_subscriptions(
        )
