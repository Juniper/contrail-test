...
# The return value in boolval will be 0 if error present, 1 otherwise and in ret will be a list of dict specifying node# , service and error for that node and service if present:
# boolval = 0
