...
def execute_zeroize(host, username, password, timeout=10):
...
def execute_backup_config(host, username, password, filepath, timeout=60):
...
@retry(delay=10, tries=2)
def execute_restore_config(host, username, password, filepath, timeout=60):
