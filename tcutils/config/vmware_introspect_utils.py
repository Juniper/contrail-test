...
class VRouterDetails():
    '''Vrouter details objects'''
    def __init__(self,d={}):
        self.virtual_machines = []
        self.state = d['state']
        self.esxiHost = d['EsxiHost']
        self.ip = d['ipAddr']
        self.virtual_networks = [VirtualNetworks(vn['name']) for vn in d['VirtualNetworks']['list']]
        for element in d['VirtualNetworks']['list']:
            net = element['name']
