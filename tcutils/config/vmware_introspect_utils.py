...
class uuid(Result):
    def __init__(self,d={}):
        super(uuid, self).__init__(d)

class name(Result):
    def __init__(self,d={}):
        super(name, self).__init__(d)

class vrouter_uuid(Result):
    def __init__(self,d={}):
        super(vrouter_uuid, self).__init__(d)

class interfaces(Result):
    def __init__(self,d={}):
        super(interfaces, self).__init__(d)
    
class VirtualMachinesInterface(Result):
    def __init__(self,d={}):
        super(VirtualMachinesInterface, self).__init__(d)
