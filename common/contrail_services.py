CONTRAIL_SERVICES_CONTAINER_MAP = {
    ...
    'control': ['control_control', 'contrail-control_contrail', 'control_contrail-controller-control'],
    ...
    'webui': ['webui_web', 'contrail-webui_', 'webui-web'],
    'webui-middleware': ['webui_job', 'contrail-webui-middleware', 'controller-webui-job'],
    ...
    'analytics-kafka': ['analyticsdatabase_kafka', 'contrail-kafka', 'analytics_database_kafka', 'analytics_kafka', 'kafka_kafka'],
    'analytics-zookeeper': ['analyticsdatabase_zookeeper','analytics-zookeeper',
    ...
    'vrouter-nodemgr': ['vrouter_nodemgr', 'vrouter-nodemgr', 'vrouter_agent_nodemgr', 'contrail-agent-nodemgr'],
    'config-nodemgr': ['config_nodemgr', 'config-nodemgr'],
    'analytics-nodemgr': ['analytics_nodemgr', 'analytics-nodemgr','contrail-analytics-nodemgr'],
    'control-nodemgr': ['control_nodemgr', 'control-nodemgr'],
    'analyticsdb-nodemgr': ['analyticsdatabase_nodemgr', 'contrail-database-nodemgr',
