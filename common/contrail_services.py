_CONTRAIL_SERVICES_OPENSHIFT_CONTAINER_MAP = {
    ...
    # Control
    'control': ['k8s_contrail-controller-control'],
    'dns': ['k8s_contrail-controller-control-dns'],
    'named': ['k8s_contrail-controller-control-named'],
    # Analytics
...
def get_contrail_services_map(orch='openstack'):
    if orch == 'openshift':
