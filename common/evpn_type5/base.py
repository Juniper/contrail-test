...
class BaseEvpnType5Test(BaseVrouterTest):
    ...
    def setup_evpn_type5(self, vn=None, vmi=None, vm=None, lrs=None, verify=True):
        ...
        self.contrail_vnc_api_h = ContrailVncApi(self.connections.vnc_lib, self.logger)
        self.contrail_vnc_api_h.enable_vxlan_routing()
...
#       # end update_vrouter_config_encap
    def delete_auto_lr(self, fabric_name):
        ...
        self.contrail_vnc_api_h.delete_router(fq_name=lr_fq_name)
