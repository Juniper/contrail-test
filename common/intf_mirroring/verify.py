...
class VerifyIntfMirror(VerifySvcMirror):
    ...
    def verify_intf_mirroring(self):
        ...
        self.vm1_fixture_vn1 = self.config_vm(
            self.vn1_fixture, self.vm1_name_vn1, node_name=compute_1, image_name=image_name)

        self.vm2_fixture_vn2 = self.config_vm(
            self.vn2_fixture, self.vm2_name_vn2, node_name=compute_2, image_name=image_name)

        self.mirror_vm_fixture_vn1 = self.config_vm(
            self.vn1_fixture, self.mirror_vm_name_vn1, node_name=compute_3, image_name=image_name)
        self.mirror_vm_ip_vn1 = self.mirror_vm_fixture_vn1.get_vm_ips(self.vn1_fq_name)[0]

        self.vm2_fixture_vn1 = self.config_vm(
            self.vn1_fixture, self.vm2_name_vn1, node_name=compute_2, image_name=image_name)
       
        self.mirror_vm_fixture_vn3 = self.config_vm(
           self.vn3_fixture, self.mirror_vm_name_vn3, node_name=compute_3, image_name=image_name)
        self.mirror_vm_ip_vn3 = self.mirror_vm_fixture_vn3.get_vm_ips(self.vn3_fq_name)[0] 

        self.mirror_vm_fixture_vn2 = self.config_vm(
           self.vn2_fixture, self.mirror_vm_name_vn2, node_name=compute_3, image_name=image_name)
        self.mirror_vm_ip_vn3 = self.mirror_vm_fixture_vn3.get_vm_ips(self.vn3_fq_name)[0]
