...
Templates = {"create_network": cwd+"/templates/create_network.json",
             "create_server": cwd+"/templates/create_server.json",
             "create_server_node_profile": cwd+"/templates/create_server_node_profile.json"}
...
#            device.cleanUp(force=True)
    ...
    def create_network(self):
        network_create_payload = json.load()

    def create_server_object(self):
        pass

    def create_server_node_profile(self):
        pass
