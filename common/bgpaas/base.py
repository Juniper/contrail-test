...
class BaseBGPaaS(BaseNeutronTest, BaseHC):
    ...
    def config_bgp_on_vsrx(
        ...
        if bfd_enabled:
            cmdList.extend(
                ('set protocols bgp group bgpaas bfd-liveness-detection minimum-interval 1000',
        ...
        cmdList.extend(
            ('set protocols bgp group bgpaas type external',
             ...
             'set protocols bgp group bgpaas hold-time 90',
             'set policy-options policy-statement export-to-bgp term allow_local from protocol direct',
             ...
             str(bgp_ip),
                ...
                'set policy-options policy-statement export-to-bgp term deny_all then reject'))
