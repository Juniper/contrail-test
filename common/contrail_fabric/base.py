...
class BaseFabricTest(BaseNeutronTest, FabricUtils):
    ...
    def add_device(self, device_name, vendor, model, device_family, role, management_ip, tunnel_ip, loopback_ip, vn_fixtures=None, bgp_router=None, tsn_name=None, username=None, password=None):
        pass
